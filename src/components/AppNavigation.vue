<template>
    <v-navigation-drawer v-model="drawer" :rail="rail" permanent @click="rail = false">
        ...
        <v-list density="compact" nav>
            ...
            <!-- External Links -->
            <v-list-item prepend-icon="mdi-github" title="GitHub" value="github"
                href="https://github.com/vuetifyjs/vuetify" target="_blank"></v-list-item>

            <v-list-item prepend-icon="mdi-book-open-variant" title="Documentation" value="docs"
                href="https://vuetifyjs.com/" target="_blank"></v-list-item>
        </v-list>
