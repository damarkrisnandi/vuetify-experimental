        ...
        <v-card class="mb-8" elevation="2">
            ...
            <v-card-text class="pa-6">
                <v-row class="reverse-container">
                    ...
                    <v-col cols="12" md="4" class="order-0 order-md-3">
        ...
        <v-card class="mb-8" elevation="2">
            ...
            <v-card-text class="pa-6">
                <div class="mb-4 text-center">
                    <v-btn color="primary" @click="toggleOrder" prepend-icon="mdi-swap-horizontal">
                        Toggle Order (Current: {{ isReversed ? 'C-B-A' : 'A-B-C' }})
                    </v-btn>
                </div>

                <v-row>
                    <v-col v-for="(component, index) in orderedComponents" :key="component.id" cols="12" md="4">
