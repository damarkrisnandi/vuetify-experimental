        ...
        <v-card elevation="2">
          ...
          <v-card-text>
            ...
            <v-text-field
              ...
              placeholder="Text scales with global setting"
              variant="outlined"
              class="mb-3"
            />
            ...
            <v-row>
              <v-col cols="12" md="6">
                ...
                <v-list>
                  <v-list-item>
                    <v-list-item-title>🎯 Affects entire application</v-list-item-title>
                    <v-list-item-subtitle>All text elements scale proportionally</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>♿ Accessibility focused</v-list-item-title>
                    <v-list-item-subtitle>Helps users with visual impairments</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>⚡ Real-time updates</v-list-item-title>
