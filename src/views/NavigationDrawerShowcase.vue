            ...
            <v-row>
              <v-col cols="12" md="8">
                ...
                <p class="text-body-1 mb-3">
                  Component ini mendemonstrasikan v-navigation-drawer yang <strong>tidak dapat dibuka menggunakan swipe gesture</strong> 
                  di mobile device. Drawer hanya bisa dibuka dan ditutup melalui <strong>button action saja</strong>.
                </p>
                <p class="text-body-1">
                  Ini sangat berguna untuk aplikasi yang membutuhkan kontrol ketat terhadap navigasi, 
                  atau ketika Anda ingin mencegah pembukaan drawer secara tidak sengaja saat user melakukan scroll horizontal.
                </p>
              </v-col>
              <v-col cols="12" md="4">
                  ...
                  <v-card-text>
                    ...
                    <v-list density="compact">
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-title>Tambahkan menu items sesuai kebutuhan</v-list-item-title>
                      </v-list-item>
                      <v-list-item>
                        <template v-slot:prepend>
                          <v-icon color="primary">mdi-resize</v-icon>
                        </template>
                        <v-list-item-title>Atur width drawer (default: 280px)</v-list-item-title>
                      </v-list-item>
                    </v-list>
                  </v-card-text>
                </v-card>
                  ...
                  <v-card-text>
                    <v-list density="compact">
                      <v-list-item>
                        ...
                        <v-list-item-title>Drawer hanya bisa dibuka via button</v-list-item-title>
                      </v-list-item>
                      <v-list-item>
                        <template v-slot:prepend>
                          <v-icon color="success">mdi-check</v-icon>
                        </template>
                        <v-list-item-title>Swipe dari edge screen tidak membuka drawer</v-list-item-title>
                      </v-list-item>
                      <v-list-item>
                        <template v-slot:prepend>
                          <v-icon color="success">mdi-check</v-icon>
                        </template>
                        <v-list-item-title>Click outside drawer akan menutup drawer</v-list-item-title>
                      </v-list-item>
                      <v-list-item>
                        <template v-slot:prepend>
                          <v-icon color="success">mdi-check</v-icon>
                        </template>
                        <v-list-item-title>Resize window tidak auto-open drawer</v-list-item-title>
                      </v-list-item>
                    </v-list>
                  </v-card-text>
                </v-card>
                  ...
                  <v-card-text>
                    <v-list density="compact">
                      <v-list-item>
                        ...
                        <v-list-item-title>Drawer TIDAK akan buka dengan swipe gesture</v-list-item-title>
                      </v-list-item>
                      <v-list-item>
                        <template v-slot:prepend>
                          <v-icon color="error">mdi-close</v-icon>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-title>TIDAK responsive auto-show di desktop</v-list-item-title>
                      </v-list-item>
                    </v-list>
                  </v-card-text>
                </v-card>
